...
@Configuration
public class SpringIntegrationCh0606DemoApplication implements ApplicationRunner {

    @Autowired
    private PrinterGateway printerGateway;

    public static void main(String[] args) {
        SpringApplication.run(SpringIntegrationCh0606DemoApplication.class, args);
    }
    ...
    @Bean
    public MessageChannel payloadEnricherChannel() {
        return new DirectChannel();
    }
    ...
    @Bean
    @Transformer(inputChannel = "payloadEnricherChannel", outputChannel = "filterChannel")
