...
@Configuration
public class SpringIntegrationCh1104DemoApplication implements ApplicationRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpringIntegrationCh1104DemoApplication.class, args);
    }
