...
@Configuration
public class SpringIntegrationCh1204DemoApplication implements ApplicationRunner {

    @Autowired
    private SimpleGateway simpleGateway;

    public static void main(String[] args) {
        SpringApplication.run(SpringIntegrationCh1204DemoApplication.class, args);
    }
    ...
    public HttpRequestExecutingMessageHandler httpOutboundGataway() {
        ...
        httpRequestExecutingMessageHandler.setExpectedResponseType(String.class);
        httpRequestExecutingMessageHandler.setExpectReply(true);
        httpRequestExecutingMessageHandler.setOutputChannel(httpReplyChannel());
