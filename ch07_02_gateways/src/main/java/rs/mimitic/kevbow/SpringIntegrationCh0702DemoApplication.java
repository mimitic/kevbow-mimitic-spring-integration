...
@Configuration
public class SpringIntegrationCh0702DemoApplication implements ApplicationRunner {

    @Autowired
    private EnhancedPrinterGateway enhancedPrinterGateway;

    public static void main(String[] args) {
        SpringApplication.run(SpringIntegrationCh0702DemoApplication.class, args);
    }
