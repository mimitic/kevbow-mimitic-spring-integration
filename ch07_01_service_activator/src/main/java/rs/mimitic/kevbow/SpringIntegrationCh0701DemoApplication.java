...
@Configuration
public class SpringIntegrationCh0701DemoApplication implements ApplicationRunner {

    @Autowired
    private PrinterGateway printerGateway;

    public static void main(String[] args) {
        SpringApplication.run(SpringIntegrationCh0701DemoApplication.class, args);
    }
